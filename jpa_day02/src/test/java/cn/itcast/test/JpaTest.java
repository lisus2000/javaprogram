...
public class JpaTest {
    ...
    public void testFindCustNameAndId(){
        Customer customer = customerDao.findCustNameAndId(3l, "黑马");
        System.out.println(customer);
    }
    /**
     * 测试jpql的更新操作
    ...
    public void testUpdateCustomer(){
        customerDao.updateCustomer(4l,"黑马程序员V5");
    }
    ...
    public void testFindByCustNameLikeAndCustIndustry() {
        Customer customer = customerDao.findByCustNameLikeAndCustIndustry("传智播客%", "教育");
        System.out.println(customer);
    }
}
